import { e as createComponent, m as maybeRenderHead, k as renderScript, r as renderTemplate, h as addAttribute, l as renderComponent, n as Fragment, f as createAstro, o as renderHead } from '../chunks/astro/server_BaT8YAxC.mjs';
import 'clsx';
/* empty css                                 */
...
const siteConfig = {
  ...
  description: "Portfolio website of Ayush Gupta",
  accentColor: "#1d4ed8",
  social: {
    email: "ayush.me1204@gmail.com",
    linkedin: "https://linkedin.com/in/ayushguptadev",
    twitter: "https://x.com/MenaceAyush",
    github: "https://github.com/MenaceG"
  },
  aboutMe: "I have been deeply interested in computers since childhood, spending countless hours exploring and experimenting with technology. This passion led me to pursue a Bachelor of Computer Applications (BCA), where I honed my technical skills. I specialize in troubleshooting and fixing code and systems, and I take pride in solving complex problems. I continuously explore new technologies and development stacks, driven by a desire to improve and expand my skillset.",
  skills: ["react", "postgresql", "mongodb", "javascript", "mysql", "flask", "python", "java", "c", "cplusplus", "nodedotjs", "expressjs", "tailwindcss", "git", "html", "css", "github", "linux", "stackoverflow", "visualstudiocode", "android", "androidstudio", "vercel  ", "vim", "angular", "aws", "docker", "npm"],
  projects: [
    {
      name: "MindCheck",
      description: "A full-stack web app built with React, Node.js, and MongoDB that provides mental health self-assessments, AI-powered chat support, and nearby doctor recommendations.",
      link: "https://aidevroundup.com/?ref=devportfolio",
      skills: ["React", "Node.js", "PostgreSQL", "MongoDB", "ExpressJs", "OpenAI API", "Javascript"]
    },
    {
      name: "Chrome Extension Mastery: Build Full-Stack Extensions with React & Node.js",
      description: "Master the art of building production-ready, full-stack Chrome Extensions using modern web technologies and best practices",
  ...
  experience: [
    ...
    },
    {
      ...
      bullets: ["Designed and developed the user interface for Carnaama's web platform, focusing on creating a modern, intuitive, and visually appealing design.", "Leveraged ReactJs hooks (useState, useEffect) for state management and optimized rendering, ensuring efficient and maintainable code.", "Utilized Tailwind CSS to build responsive and highly customizable UI components, ensuring fast development and consistent styling across pages."]
    },
    {
      company: "Hexovision",
      title: "Web Developer",
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header id="header" class="fixed top-0 left-0 right-0 z-50 hidden md:block transition-all duration-300" data-astro-cid-3ef6ksr2> <nav class="max-w-7xl mx-auto px-8 py-4" data-astro-cid-3ef6ksr2> <ul class="flex items-center gap-8 justify-center" data-astro-cid-3ef6ksr2> <li data-astro-cid-3ef6ksr2> <a href="#about" class="text-gray-700 hover:text-black transition-colors font-medium" data-astro-cid-3ef6ksr2>
About
...
Education
</a> </li>`} </ul> </nav> </header> ${renderScript($$result, "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/components/Header.astro?astro&type=script&index=0&lang.ts")} `;
}, "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/components/Header.astro", void 0);
...
I'm <span${addAttribute({ color: siteConfig.accentColor }, "style")} data-astro-cid-bbe6dxrz>${siteConfig.name}</span> </h1> <p class="mt-4 sm:mt-6 md:mt-8 text-pretty text-base sm:text-lg md:text-xl/8 font-medium text-gray-600 animate-fade-in animation-delay-400" data-astro-cid-bbe6dxrz> ${siteConfig.title} </p> </div> </div> <div class="absolute bottom-0 left-0 right-0 p-8 sm:p-12 md:p-24 flex gap-x-4 sm:gap-x-6 md:gap-x-8 text-gray-700 animate-fade-in animation-delay-600" data-astro-cid-bbe6dxrz> ${renderTemplate`<a${addAttribute(`mailto:${siteConfig.social.email}`, "href")} aria-label="Email" class="transition-colors duration-300 hover:text-[var(--accent-color)]" data-astro-cid-bbe6dxrz> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8" data-astro-cid-bbe6dxrz> <path stroke="none" d="M0 0h24v24H0z" fill="none" data-astro-cid-bbe6dxrz></path> <path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z" data-astro-cid-bbe6dxrz></path> <path d="M3 7l9 6l9 -6" data-astro-cid-bbe6dxrz></path> </svg> </a>`} ${renderTemplate`<a${addAttribute(siteConfig.social.linkedin, "href")} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="transition-colors duration-300 hover:text-[var(--accent-color)]" data-astro-cid-bbe6dxrz> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8" data-astro-cid-bbe6dxrz> ${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-bbe6dxrz": true }, { "default": ($$result2) => renderTemplate` <path stroke="none" d="M0 0h24v24H0z" fill="none" data-astro-cid-bbe6dxrz></path> <path d="M8 11v5" data-astro-cid-bbe6dxrz></path> <path d="M8 8v.01" data-astro-cid-bbe6dxrz></path> <path d="M12 16v-5" data-astro-cid-bbe6dxrz></path> <path d="M16 16v-3a2 2 0 1 0 -4 0" data-astro-cid-bbe6dxrz></path> <path d="M3 7a4 4 0 0 1 4 -4h10a4 4 0 0 1 4 4v10a4 4 0 0 1 -4 4h-10a4 4 0 0 1 -4 -4z" data-astro-cid-bbe6dxrz></path> ` })} </svg> </a>`} ${renderTemplate`<a${addAttribute(siteConfig.social.twitter, "href")} target="_blank" rel="noopener noreferrer" aria-label="Twitter" class="transition-colors duration-300 hover:text-[var(--accent-color)]" data-astro-cid-bbe6dxrz> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8" data-astro-cid-bbe6dxrz> ${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-bbe6dxrz": true }, { "default": ($$result2) => renderTemplate` <path stroke="none" d="M0 0h24v24H0z" fill="none" data-astro-cid-bbe6dxrz></path> <path d="M4 4l11.733 16h4.267l-11.733 -16z" data-astro-cid-bbe6dxrz></path> <path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772" data-astro-cid-bbe6dxrz></path> ` })} </svg> </a>`} ${renderTemplate`<a${addAttribute(siteConfig.social.github, "href")} target="_blank" rel="noopener noreferrer" aria-label="GitHub" class="transition-colors duration-300 hover:text-[var(--accent-color)]" data-astro-cid-bbe6dxrz> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8" data-astro-cid-bbe6dxrz> ${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-bbe6dxrz": true }, { "default": ($$result2) => renderTemplate` <path stroke="none" d="M0 0h24v24H0z" fill="none" data-astro-cid-bbe6dxrz></path> <path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5" data-astro-cid-bbe6dxrz></path> ` })} </svg> </a>`} </div> </div> `;
}, "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/components/Hero.astro", void 0);
...
}, "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/components/About.astro", void 0);
...
}, "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/components/Projects.astro", void 0);
...
}, "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/components/Experience.astro", void 0);
...
}, "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/components/Education.astro", void 0);
...
}, "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/components/Footer.astro", void 0);

const $$Astro = createAstro();
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Index;
  return renderTemplate`<html lang="en"> <head><meta charset="utf-8"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta name="description"${addAttribute(siteConfig.description, "content")}><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet"><title>${siteConfig.name} - ${siteConfig.title}</title>${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, {})} <section> ${renderComponent($$result, "Hero", $$Hero, {})} ${renderComponent($$result, "About", $$About, {})} ${renderComponent($$result, "Projects", $$Projects, {})} ${renderComponent($$result, "Experience", $$Experience, {})} ${renderComponent($$result, "Education", $$Education, {})} </section> ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
}, "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/pages/index.astro", void 0);

const $$file = "C:/Users/Ayush/Desktop/projects/aboutme/ayushgupta/src/pages/index.astro";
const $$url = "";
