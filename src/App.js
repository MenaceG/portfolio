...
function App() {
  return (
    <div className="App bg-black text-white flex items-center flex-col">
      <Navbar />

      <div className="intro mb-10 min-w-200">
      ...
      <div className='about mb-10 max-w-200'>
      ...
      <div className="skills mb-10 min-w-200">
        <h2 className="w-full md:w-full font-bold text-3xl mb-4">Skills</h2>
        <div className='flex border-2 border-[#1c1c1e] rounded-lg p-4'>
          <div className="w-half skillBox m-4 mr-20">
          ...
          <div className='flex w-half skillsphere'>
            <IconCloud
      ...
      <div className='work mb-10 min-w-200'>
